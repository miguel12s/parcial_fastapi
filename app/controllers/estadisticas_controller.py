...
class EstadisticasController():
    ...
    SUM(CASE WHEN txe.estado = 'terminada' THEN 1 ELSE 0 END) AS tutorias_terminadas,
    SUM(CASE WHEN txe.estado = 'eliminada' THEN 1 ELSE 0 END) AS tutorias_eliminadas
